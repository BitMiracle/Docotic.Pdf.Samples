...
Use [the CreateImage(PdfImageFrame) method](https://api.docotic.com/pdfdocument-createimage#pdfimageframe_) to add any image frame to a PDF document. You can add image frames in any order. There is no need to add all the frames.
