...
Namespace BitMiracle.Docotic.Pdf.Samples
    Class PageObjectCopier
        ...
        Public Sub New(
            ...
            Optional options As PdfObjectExtractionOptions = Nothing,
            Optional replaceColor As Func(Of PdfColor, PdfColor) = Nothing,
            Optional shouldRemoveText As Func(Of PdfTextData, Boolean) = Nothing)
