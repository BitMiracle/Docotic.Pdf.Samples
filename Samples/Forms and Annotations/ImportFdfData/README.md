# Import FDF data to PDF document in C# and VB.NET
...
You should use [PdfDocument.ImportFdf methods](https://api.docotic.com/pdfdocument-importfdf) to import form data and fill corresponding fields in a PDF form.
